...
public class MortalityCurve {
   ...
   */
  public static final MortalityCurve DEFAULT = MortalityCurve.of(0.042);
   ...
   * @return the instance
   */
  public static MortalityCurve of(double ufr) {
    return new MortalityCurve(ufr);
  }

  // private constructor
  private MortalityCurve(double ufr) {
