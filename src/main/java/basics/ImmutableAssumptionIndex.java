 ...
 * <p>
 * A standard immutable implementation of {@link AssumptionIndex}.
 * <p>
 * In most cases, applications should refer to indices by name, using {@link AssumptionIndex#of(String)}.
 * The named index will typically be resolved to an instance of this class.
 * As such, it is recommended to use the {@code AssumptionIndex} interface in application
 * code rather than directly referring to this class.
 */
@BeanDefinition
public final class ImmutableAssumptionIndex
    implements AssumptionIndex, ImmutableBean, Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof ImmutableAssumptionIndex) {
      return name.equals(((ImmutableAssumptionIndex) obj).name);
    }
    return false;
  }
  ...
  public String toString() {
    ...
    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code ImmutableAssumptionIndex}.
     * @return the meta-bean, not null
     */
    public static ImmutableAssumptionIndex.Meta meta() {
        return ImmutableAssumptionIndex.Meta.INSTANCE;
    }

    static {
        MetaBean.register(ImmutableAssumptionIndex.Meta.INSTANCE);
    }
     ...
     */
    public static ImmutableAssumptionIndex.Builder builder() {
        return new ImmutableAssumptionIndex.Builder();
    }

    private ImmutableAssumptionIndex(
            String name,
            Country region,
            Currency currency,
            boolean active,
    ...
    @Override
    public ImmutableAssumptionIndex.Meta metaBean() {
        return ImmutableAssumptionIndex.Meta.INSTANCE;
    }
    ...
    public static final class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<Frequency> publicationFrequency = DirectMetaProperty.ofImmutable(
                this, "publicationFrequency", ImmutableAssumptionIndex.class, Frequency.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public ImmutableAssumptionIndex.Builder builder() {
            return new ImmutableAssumptionIndex.Builder();
        }

        @Override
        public Class<? extends ImmutableAssumptionIndex> beanType() {
            return ImmutableAssumptionIndex.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 3373707:  // name
                    return ((ImmutableAssumptionIndex) bean).getName();
                case -934795532:  // region
                    return ((ImmutableAssumptionIndex) bean).getRegion();
                case 575402001:  // currency
                    return ((ImmutableAssumptionIndex) bean).getCurrency();
                case -1422950650:  // active
                    return ((ImmutableAssumptionIndex) bean).isActive();
                case -1407208304:  // publicationFrequency
                    return ((ImmutableAssumptionIndex) bean).getPublicationFrequency();
            }
    ...
    //-----------------------------------------------------------------------
    /**
     * The bean-builder for {@code ImmutableAssumptionIndex}.
     */
    public static final class Builder extends DirectFieldsBeanBuilder<ImmutableAssumptionIndex> {
         ...
         */
        private Builder(ImmutableAssumptionIndex beanToCopy) {
        ...
        @Override
        public ImmutableAssumptionIndex build() {
            return new ImmutableAssumptionIndex(
                    name,
                    region,
                    currency,
                    active,
        ...
        public String toString() {
            ...
            buf.append("ImmutableAssumptionIndex.Builder{");
