 ...
 * <p>
 * This provides historic and forward values for a single {@link AssumptionIndex}, such as 'US-CPI-U'.
 * This is typically used in inflation products.
 */
public interface AssumptionIndexValues
    extends MarketDataView, ParameterizedData {

  /**
   * Obtains an instance from a curve and time-series of fixings.
   * <p>
   * The only supported implementation at present is {@link SimpleAssumptionIndexValues}.
   ...
   */
  public static AssumptionIndexValues of(
      AssumptionIndex index,
      LocalDate valuationDate,
      Curve forwardCurve,
      LocalDateDoubleTimeSeries fixings) {

    return SimpleAssumptionIndexValues.of(index, valuationDate, forwardCurve, fixings);
  }
   ...
   */
  public abstract AssumptionIndex getIndex();
  ...
  //-------------------------------------------------------------------------
  @Override
  public abstract AssumptionIndexValues withParameter(int parameterIndex, double newValue);

  @Override
  public abstract AssumptionIndexValues withPerturbation(ParameterPerturbation perturbation);
   ...
   */
  public abstract double value(AssumptionIndexObservation observation);
   ...
   * The sensitivity refers to the result of {@link #value(AssumptionIndexObservation)}.
   * 
   * @param observation  the rate observation, including the fixing month
   * @return the point sensitivity of the value
   * @throws RuntimeException if the result cannot be calculated
   */
  public abstract PointSensitivityBuilder valuePointSensitivity(AssumptionIndexObservation observation);
   ...
   * @throws RuntimeException if the result cannot be calculated
   */
  public abstract CurrencyParameterSensitivities parameterSensitivity(AssumptionRateSensitivity pointSensitivity);
