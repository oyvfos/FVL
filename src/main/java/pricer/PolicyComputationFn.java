 ...
 */
public interface PolicyComputationFn<T extends PolicyComputation> {
   ...
   */
  public static PolicyComputationFn<PolicyComputation> standard() {
    return DispatchingPolicyComputationFn.DEFAULT;
  }
