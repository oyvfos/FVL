 ...
 */
public class PresentValueWithZspread extends AbstractDerivedCalculationFunction<SecuritizedProductTrade, CurrencyScenarioArray> {

private static Class<SecuritizedProductTrade<FixedCouponBond>> targetType;

public static final PresentValueWithZspread INSTANCE = new PresentValueWithZspread();
protected PresentValueWithZspread(Class<SecuritizedProductTrade<FixedCouponBond>> targetType, Measure measure) {
		
		super(SecuritizedProductTrade.class, measure);
		// TODO Auto-generated constructor stub
	}
//  protected PresentValueWithZspread(Measure measure) {
//		super(SecuritizedProductTrade<?>.class,measure);
//		// TODO Auto-generated constructor stub
//	}
  
  
  public PresentValueWithZspread() {
	    this(targetType, Measures1.presentValueWithSpread);
	  }
...
//-------------------------------------------------------------------------
  ...
  interface SingleMeasureCalculation {
    public abstract CurrencyScenarioArray calculate(
    		SecuritizedProductTrade<FixedCouponBond> securitizedProduct,
...
public Measure measure() {
	...
	return Measures1.presentValueWithSpread;
}
//@Override
//public CurrencyScenarioArray calculate(SecurityTrade target, Map<Measure, Object> requiredMeasures,
...
//    
//		SingleMeasureCalculation calculator = FixedCouponBondMeasureCalculations1.DEFAULT::presentValueWithSpread;
//	
...
//@Override
//public CurrencyScenarioArray calculate(SecuritizedProductTrade<FixedCouponBond> target,
//		Map<Measure, Object> requiredMeasures, CalculationParameters parameters, ScenarioMarketData marketData,
//		ReferenceData refData) {
//	// TODO Auto-generated method stub
//	return null;
//}
@Override
public CurrencyScenarioArray calculate(SecuritizedProductTrade target, Map<Measure, Object> requiredMeasures,
		CalculationParameters parameters, ScenarioMarketData marketData, ReferenceData refData) {
	// TODO Auto-generated method stub
	return null;
}
