 ...
 */
public final class TransitionRatesId
    implements ReferenceDataId<TransitionRates>, Serializable {
   ...
   */
  public static TransitionRatesId of(String scheme, String value) {
   ...
   * @return the security identifier
   */
  public static TransitionRatesId of(StandardId standardId) {
    return new TransitionRatesId(standardId);
  }
   ...
   */
  @FromString
  public static TransitionRatesId parse(String str) {
    return new TransitionRatesId(StandardId.parse(str));
  }

  // creates an identifier
  private TransitionRatesId(StandardId standardId) {
   ...
   */
  @Override
  public Class<TransitionRates> getReferenceDataType() {
    return TransitionRates.class;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof TransitionRatesId) {
      return standardId.equals(((TransitionRatesId) obj).standardId);
    }
    return false;
  }
