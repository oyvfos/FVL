 ...
 */
public final class DifferentiationMatrixId
    implements ReferenceDataId<DifferentiationMatrix>, Serializable {
   ...
   */
  public static DifferentiationMatrixId of(String scheme, String value) {
   ...
   * @return the security identifier
   */
  public static DifferentiationMatrixId of(StandardId standardId) {
    return new DifferentiationMatrixId(standardId);
  }
   ...
   */
  @FromString
  public static DifferentiationMatrixId parse(String str) {
    return new DifferentiationMatrixId(StandardId.parse(str));
  }

  // creates an identifier
  private DifferentiationMatrixId(StandardId standardId) {
   ...
   */
  @Override
  public Class<DifferentiationMatrix> getReferenceDataType() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof DifferentiationMatrixId) {
      return standardId.equals(((DifferentiationMatrixId) obj).standardId);
    }
    return false;
  }
